...
export default defineConfig({
  ...
  define: {
    ...
    "VITE_APP_BUSINESS_CARD_PRIMARY_COLOR": JSON.stringify(process.env.VITE_APP_BUSINESS_CARD_PRIMARY_COLOR),
    "VITE_APP_BUSINESS_CARD_SECONDARY_COLOR": JSON.stringify(process.env.VITE_APP_BUSINESS_CARD_SECONDARY_COLOR),
    "VITE_APP_BUSINESS_CARD_TITLE": JSON.stringify(process.env.VITE_APP_BUSINESS_CARD_TITLE),
    "VITE_APP_BUSINESS_CARD_SUB_TITLE": JSON.stringify(process.env.VITE_APP_BUSINESS_CARD_SUB_TITLE),
    ...
    "VITE_APP_BUSINESS_CARD_CONTACT_PHONE": JSON.stringify(process.env.VITE_APP_BUSINESS_CARD_CONTACT_PHONE),
    "VITE_APP_BUSINESS_CARD_CONTACT_GITHUB": JSON.stringify(process.env.VITE_APP_BUSINESS_CARD_CONTACT_GITHUB),
    "VITE_APP_BUSINESS_CARD_CONTACT_LINKEDIN": JSON.stringify(process.env.VITE_APP_BUSINESS_CARD_CONTACT_LINKEDIN),
